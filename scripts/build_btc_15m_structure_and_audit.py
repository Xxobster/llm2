"""Refresh BTC candles tip, build 15m structure warehouse, run leakage audit."""
...
SYMBOL = "BTCUSDT"
OUT = ARTIFACTS / "reports" / "structure_v1_btc_15m_warehouse_audit_latest.json"
...
def main() -> int:
    ...
    print("[1/3] update_series BTCUSDT 15m …", flush=True)
    ...
    for tf in ("1h", "4h"):
        print(f"[1b] update_series BTCUSDT {tf} tip …", flush=True)
