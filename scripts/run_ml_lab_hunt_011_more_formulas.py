"""ML lab hunt 011 — second invented causal formula pack. RESEARCH_ONLY."""
...
from llm2.ml_lab.idea_catalog_h import (  # noqa: E402
    IDEA_IDS_H,
...
def main() -> int:
    ...
    return run_catalog_hunt(
        prereg=_ROOT / "configs" / "preregister" / "ml_lab_hunt_011_more_formulas.yaml",
        db_dir=ARTIFACTS / "sqlite" / "ml_lab_hunt_011_more_formulas",
        out_stem="hunt_011_more_formulas",
        title="ML lab hunt 011 (second invented causal formula pack)",
        idea_ids=IDEA_IDS_H,
        signals_fn=signals_h,
        leak_builder=build_features_for_guard,
        ledger_name="ML_LAB_HUNT_011",
