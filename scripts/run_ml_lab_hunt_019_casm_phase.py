"""ML lab hunt 019 — CASM-A + Hilbert phase router. RESEARCH_ONLY."""
...
from llm2.ml_lab.idea_catalog_casm import (  # noqa: E402
    IDEA_IDS_CASM,
...
def main() -> int:
    ...
    return run_catalog_hunt(
        prereg=_ROOT / "configs" / "preregister" / "ml_lab_hunt_019_casm_phase.yaml",
        db_dir=ARTIFACTS / "sqlite" / "ml_lab_hunt_019_casm_phase",
        out_stem="hunt_019_casm_phase",
        title="ML lab hunt 019 (crowding-absorption + Hilbert phase router)",
        idea_ids=IDEA_IDS_CASM,
        signals_fn=signals_casm,
        leak_builder=build_features_for_guard,
        ledger_name="ML_LAB_HUNT_019",
