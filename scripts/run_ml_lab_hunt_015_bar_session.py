"""ML lab hunt 015 — bar-shape / UTC session formulas. RESEARCH_ONLY."""
...
from llm2.ml_lab.idea_catalog_l import (  # noqa: E402
    IDEA_IDS_L,
...
def main() -> int:
    ...
    return run_catalog_hunt(
        prereg=_ROOT / "configs" / "preregister" / "ml_lab_hunt_015_bar_session.yaml",
        db_dir=ARTIFACTS / "sqlite" / "ml_lab_hunt_015_bar_session",
        out_stem="hunt_015_bar_session",
        title="ML lab hunt 015 (bar-shape and UTC session formulas)",
        idea_ids=IDEA_IDS_L,
        signals_fn=signals_l,
        leak_builder=build_features_for_guard,
        ledger_name="ML_LAB_HUNT_015",
