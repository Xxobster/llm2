"""ML lab hunt 009 — invented causal time-series formulas. RESEARCH_ONLY."""
...
def main() -> int:
    ...
    return run_catalog_hunt(
        prereg=_ROOT / "configs" / "preregister" / "ml_lab_hunt_009_causal_math.yaml",
        db_dir=ARTIFACTS / "sqlite" / "ml_lab_hunt_009_causal_math",
        out_stem="hunt_009_causal_math",
        title="ML lab hunt 009 (invented causal time-series formulas)",
        idea_ids=IDEA_IDS_F,
        signals_fn=signals_f,
        leak_builder=build_features_for_guard,
        ledger_name="ML_LAB_HUNT_009",
