"""ML lab hunt 018 — more textbook oscillators. RESEARCH_ONLY."""
...
from llm2.ml_lab.idea_catalog_o import (  # noqa: E402
    IDEA_IDS_O,
...
def main() -> int:
    ...
    return run_catalog_hunt(
        prereg=_ROOT / "configs" / "preregister" / "ml_lab_hunt_018_more_osc.yaml",
        db_dir=ARTIFACTS / "sqlite" / "ml_lab_hunt_018_more_osc",
        out_stem="hunt_018_more_osc",
        title="ML lab hunt 018 (more textbook oscillators)",
        idea_ids=IDEA_IDS_O,
        signals_fn=signals_o,
        leak_builder=build_features_for_guard,
        ledger_name="ML_LAB_HUNT_018",
