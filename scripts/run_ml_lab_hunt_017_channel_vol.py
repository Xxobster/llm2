"""ML lab hunt 017 — channels and volume oscillators. RESEARCH_ONLY."""
...
from llm2.ml_lab.idea_catalog_n import (  # noqa: E402
    IDEA_IDS_N,
...
def main() -> int:
    ...
    return run_catalog_hunt(
        prereg=_ROOT / "configs" / "preregister" / "ml_lab_hunt_017_channel_vol.yaml",
        db_dir=ARTIFACTS / "sqlite" / "ml_lab_hunt_017_channel_vol",
        out_stem="hunt_017_channel_vol",
        title="ML lab hunt 017 (channels and volume oscillators)",
        idea_ids=IDEA_IDS_N,
        signals_fn=signals_n,
        leak_builder=build_features_for_guard,
        ledger_name="ML_LAB_HUNT_017",
